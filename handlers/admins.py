...
async def resume(_, message: Message):
    if (
        ...
        await message.reply_text("▶️ Devam Ettirildi.")
...
async def skip(_, message: Message):
    if message.chat.id not in callsmusic.pytgcalls.active_calls:
        await message.reply_text("❕ Atlamak için hiçbir şey çalmıyor.")
    else:
        ...
        await message.reply_text("⏩ Mevcut şarkıyı atladım.")
...
async def admincache(_, message: Message):
    ...
    await message.reply_text("❇ Yönetici önbelleği yenilendi!")
